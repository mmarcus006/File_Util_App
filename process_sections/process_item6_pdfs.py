...
OUTPUT_DIR = BASE_DIR / "output" / "sections" / "item_6"
SCHEMA_PATH = BASE_DIR / "prompts" / "schemas" / "Item6_pydantic_schema.py"
SYSTEM_PROMPT_PATH = BASE_DIR / "prompts" / "system_prompts" / "Item_6_Prompt.md"
KEYWORD_IN_FILENAME = "ITEM_6"
...
def main_workflow():
    ...
    print("Starting Item 6 PDF processing workflow")
