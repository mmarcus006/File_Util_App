...
# Constants
BASE_DIR = Path(r"/Users/miller/projects/File_Util_App")
SPLIT_PDFS_DIR = BASE_DIR / "output" / "split_pdfs"
OUTPUT_DIR = BASE_DIR / "output" / "sections" / "item_7"
SCHEMA_PATH = BASE_DIR / "prompts" / "schemas" / "Item7_pydantic_schema.py"
SYSTEM_PROMPT_PATH = BASE_DIR / "prompts" / "system_prompts" / "Item_7_Prompt.md"
KEYWORD_IN_FILENAME = "ITEM_7"
...
def load_schema_model():
    ...
    return schema_module.Item7InitialInvestment
...
def main_workflow():
    ...
    print("Starting Item 7 PDF processing workflow")
